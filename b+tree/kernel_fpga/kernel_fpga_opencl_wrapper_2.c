...
#include "./kernel_fpga_opencl_wrapper_2.h"				// (in directory provided here)
							...
							int *reclength)
{
	...
	//====================================================================================================100
        char* findRangeK_kernel_file = "./binary/b+tree_findRangeK_default.xclbin";
        char* findRangeK_kernel_name = "findRangeK";
        cl_program program;
        cl_kernel kernel = make_kernel(context, program, device, findRangeK_kernel_file, findRangeK_kernel_name);
