...
#include "./kernel_fpga_opencl_wrapper.h"			// (in directory provided here)
			  ...
			  record *ans)
{
	...
	//====================================================================================================100
        char* findK_kernel_file = "./binary/b+tree_findK_default.xclbin";
        char* findK_kernel_name = "findK";
        cl_program program;
        cl_kernel kernel = make_kernel(context, program, device, findK_kernel_file, findK_kernel_name);
        /*
