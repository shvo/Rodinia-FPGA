...
int main(int argc, char** argv)
{
  ...
  */
    ...
    // create kernel
        char* hotspot3D_kernel_file = "./binary/direct/hotspot3D_direct.xclbin";
        char* hotspot3D_kernel_name = "hotspot3D_opt1";
        printf("begin to make kernel hotspot3D\n");
        ko_vadd = make_kernel(context, program, device_id, hotspot3D_kernel_file, hotspot3D_kernel_name); 
        printf("kernel hotspot3D is created\n");
  ...
  printf("begin to read data back\n");
  ...
  printf("data is read back from fpga\n");
